...
extension BottomContainerView {
    ...
    func setupConstraints() {
        ...
        addConstraint(NSLayoutConstraint(item: retakeButton, attribute: .centerX, relatedBy: .equal, toItem: self, attribute: .left, multiplier: 1, constant: UIScreen.main.bounds.width / 4 - ButtonPicker.Dimensions.buttonBorderSize / 3))
        ...
        addConstraint(NSLayoutConstraint(item: doneButton, attribute: .centerX, relatedBy: .equal, toItem: self, attribute: .right, multiplier: 1, constant: -(UIScreen.main.bounds.width - (ButtonPicker.Dimensions.buttonBorderSize + UIScreen.main.bounds.width)/2)/2))
